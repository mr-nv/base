...
void RenderMiscTab()
{
    ...
    ImGui::BeginGroupBox("##body_content");
    {
        ...
        ImGui::Checkbox("Bunny hop", &g_Options.misc_bhop); ImGui::SameLine(); ImGui::Checkbox("Auto strafe", &g_Options.misc_autostrafe);
...
void Menu::Initialize()
{
    ...
    ImGui_ImplDX9_Init(InputSys::Get().GetMainWindow(), g_pD3DDevice9);
