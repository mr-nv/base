...
public:
    ...
    {
        return static_cast<C_BaseEntity*>(g_pEntityList->GetClientEntityFromHandle(h));
    }
...
public:
    ...
    {
        return static_cast<C_BasePlayer*>(GetEntityByIndex(g_pEngine->GetPlayerForUserID(id)));
    }
